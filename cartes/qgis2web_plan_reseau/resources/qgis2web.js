...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:2154',
            //extent: [977987.600000, 6702564.400000, 996780.800000, 6732985.000000],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([963964.060406, 6702092.335676, 1019793.512448, 6733672.631780], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Plan du réseau de bus EvolitY</h2>';
        return titleElement;
    })(),
