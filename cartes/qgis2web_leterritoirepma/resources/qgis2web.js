...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:2154',
            //extent: [871262.700000, 6576806.800000, 1011638.900000, 6773933.400000],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([958850.120195, 6697092.686060, 1020402.091070, 6731909.962515], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Le territoire du Pays de Montbéliard Agglomération (PMA)</h2>';
        return titleElement;
    })(),
