...
//ol.proj.get("EPSG:2154").setExtent([978236.964567, 6713769.529847, 992377.267181, 6723029.437372]);
var wms_layers = [];
...
var format_Dviationdelaligne_4 = new ol.format.GeoJSON();
var features_Dviationdelaligne_4 = format_Dviationdelaligne_4.readFeatures(json_Dviationdelaligne_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:2154'});
var jsonSource_Dviationdelaligne_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Dviationdelaligne_4.addFeatures(features_Dviationdelaligne_4);
var lyr_Dviationdelaligne_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Dviationdelaligne_4, 
                style: style_Dviationdelaligne_4,
                popuplayertitle: 'Déviation de la ligne',
                interactive: false,
                title: '<img src="styles/legend/Dviationdelaligne_4.png" /> Déviation de la ligne'
            });
var format_LigneactuelleA_5 = new ol.format.GeoJSON();
var features_LigneactuelleA_5 = format_LigneactuelleA_5.readFeatures(json_LigneactuelleA_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:2154'});
var jsonSource_LigneactuelleA_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LigneactuelleA_5.addFeatures(features_LigneactuelleA_5);
var lyr_LigneactuelleA_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LigneactuelleA_5, 
                style: style_LigneactuelleA_5,
                popuplayertitle: 'Ligne actuelle (A)',
                interactive: true,
                title: '<img src="styles/legend/LigneactuelleA_5.png" /> Ligne actuelle (A)'
            });
var format_Arrtpropospourladviationdelaligne_6 = new ol.format.GeoJSON();
var features_Arrtpropospourladviationdelaligne_6 = format_Arrtpropospourladviationdelaligne_6.readFeatures(json_Arrtpropospourladviationdelaligne_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:2154'});
var jsonSource_Arrtpropospourladviationdelaligne_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Arrtpropospourladviationdelaligne_6.addFeatures(features_Arrtpropospourladviationdelaligne_6);
var lyr_Arrtpropospourladviationdelaligne_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Arrtpropospourladviationdelaligne_6, 
                style: style_Arrtpropospourladviationdelaligne_6,
                popuplayertitle: 'Arrêt proposé pour la déviation de la ligne',
                interactive: false,
                title: '<img src="styles/legend/Arrtpropospourladviationdelaligne_6.png" /> Arrêt proposé pour la déviation de la ligne'
            });
...
lyr_ESRISatelliteArcGISWorld_Imagery_0.setVisible(true);lyr_Commune_1.setVisible(true);lyr_Isochronesde10minutesdepuislesarrtsproposs_2.setVisible(true);lyr_Btimentsrsidentielsnoncouvertsparlerseauactuel_3.setVisible(true);lyr_Dviationdelaligne_4.setVisible(true);lyr_LigneactuelleA_5.setVisible(true);lyr_Arrtpropospourladviationdelaligne_6.setVisible(true);lyr_Arrtprsentsurlerseauactuel_7.setVisible(true);
var layersList = [lyr_ESRISatelliteArcGISWorld_Imagery_0,lyr_Commune_1,lyr_Isochronesde10minutesdepuislesarrtsproposs_2,lyr_Btimentsrsidentielsnoncouvertsparlerseauactuel_3,lyr_Dviationdelaligne_4,lyr_LigneactuelleA_5,lyr_Arrtpropospourladviationdelaligne_6,lyr_Arrtprsentsurlerseauactuel_7];
...
lyr_Dviationdelaligne_4.set('fieldAliases', {'fid': 'fid', 'code': 'code', 'description': 'description', 'id': 'id', 'name': 'name', 'route_color': 'route_color', 'route_id': 'route_id', 'route_long_name': 'route_long_name', 'route_short_name': 'route_short_name', 'route_text_color': 'route_text_color', 'wheelchair_boarding': 'wheelchair_boarding', });
lyr_LigneactuelleA_5.set('fieldAliases', {'fid': 'fid', 'code': 'code', 'description': 'description', 'id': 'id', 'name': 'name', 'route_color': 'route_color', 'route_id': 'route_id', 'route_long_name': 'route_long_name', 'route_short_name': 'route_short_name', 'route_text_color': 'route_text_color', 'wheelchair_boarding': 'wheelchair_boarding', 'i': 'i', 'j': 'j', 'ij': 'ij', });
lyr_Arrtpropospourladviationdelaligne_6.set('fieldAliases', {'fid': 'fid', });
...
lyr_Dviationdelaligne_4.set('fieldImages', {'fid': 'TextEdit', 'code': 'TextEdit', 'description': 'TextEdit', 'id': 'TextEdit', 'name': 'TextEdit', 'route_color': 'TextEdit', 'route_id': 'TextEdit', 'route_long_name': 'TextEdit', 'route_short_name': 'TextEdit', 'route_text_color': 'TextEdit', 'wheelchair_boarding': 'TextEdit', });
lyr_LigneactuelleA_5.set('fieldImages', {'fid': 'TextEdit', 'code': 'TextEdit', 'description': 'TextEdit', 'id': 'TextEdit', 'name': 'TextEdit', 'route_color': 'TextEdit', 'route_id': 'TextEdit', 'route_long_name': 'TextEdit', 'route_short_name': 'TextEdit', 'route_text_color': 'TextEdit', 'wheelchair_boarding': 'TextEdit', 'i': 'TextEdit', 'j': 'TextEdit', 'ij': 'TextEdit', });
lyr_Arrtpropospourladviationdelaligne_6.set('fieldImages', {'fid': 'TextEdit', });
...
lyr_Dviationdelaligne_4.set('fieldLabels', {'fid': 'no label', 'code': 'no label', 'description': 'no label', 'id': 'no label', 'name': 'no label', 'route_color': 'no label', 'route_id': 'no label', 'route_long_name': 'no label', 'route_short_name': 'no label', 'route_text_color': 'no label', 'wheelchair_boarding': 'no label', });
lyr_LigneactuelleA_5.set('fieldLabels', {'fid': 'hidden field', 'code': 'hidden field', 'description': 'hidden field', 'id': 'hidden field', 'name': 'hidden field', 'route_color': 'hidden field', 'route_id': 'hidden field', 'route_long_name': 'inline label - always visible', 'route_short_name': 'inline label - always visible', 'route_text_color': 'hidden field', 'wheelchair_boarding': 'hidden field', 'i': 'hidden field', 'j': 'hidden field', 'ij': 'hidden field', });
lyr_Arrtpropospourladviationdelaligne_6.set('fieldLabels', {'fid': 'no label', });
