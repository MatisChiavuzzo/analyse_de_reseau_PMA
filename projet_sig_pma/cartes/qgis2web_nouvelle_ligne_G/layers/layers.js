...
//ol.proj.get("EPSG:2154").setExtent([986228.596231, 6709417.577424, 998523.591993, 6717469.068746]);
var wms_layers = [];
...
var format_Isochronesde10minutesdepuislesnouveauxarrtsproposs_2 = new ol.format.GeoJSON();
var features_Isochronesde10minutesdepuislesnouveauxarrtsproposs_2 = format_Isochronesde10minutesdepuislesnouveauxarrtsproposs_2.readFeatures(json_Isochronesde10minutesdepuislesnouveauxarrtsproposs_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:2154'});
var jsonSource_Isochronesde10minutesdepuislesnouveauxarrtsproposs_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Isochronesde10minutesdepuislesnouveauxarrtsproposs_2.addFeatures(features_Isochronesde10minutesdepuislesnouveauxarrtsproposs_2);
var lyr_Isochronesde10minutesdepuislesnouveauxarrtsproposs_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Isochronesde10minutesdepuislesnouveauxarrtsproposs_2, 
                style: style_Isochronesde10minutesdepuislesnouveauxarrtsproposs_2,
                popuplayertitle: 'Isochrones de 10 minutes depuis les nouveaux arrêts proposés',
                interactive: false,
                title: '<img src="styles/legend/Isochronesde10minutesdepuislesnouveauxarrtsproposs_2.png" /> Isochrones de 10 minutes depuis les nouveaux arrêts proposés'
            });
...
var format_LigneactuelleTHNS3_4 = new ol.format.GeoJSON();
var features_LigneactuelleTHNS3_4 = format_LigneactuelleTHNS3_4.readFeatures(json_LigneactuelleTHNS3_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:2154'});
var jsonSource_LigneactuelleTHNS3_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LigneactuelleTHNS3_4.addFeatures(features_LigneactuelleTHNS3_4);
var lyr_LigneactuelleTHNS3_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LigneactuelleTHNS3_4, 
                style: style_LigneactuelleTHNS3_4,
                popuplayertitle: 'Ligne actuelle (THNS 3)',
                interactive: true,
                title: '<img src="styles/legend/LigneactuelleTHNS3_4.png" /> Ligne actuelle (THNS 3)'
            });
var format_Nouvelleligne_5 = new ol.format.GeoJSON();
var features_Nouvelleligne_5 = format_Nouvelleligne_5.readFeatures(json_Nouvelleligne_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:2154'});
var jsonSource_Nouvelleligne_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Nouvelleligne_5.addFeatures(features_Nouvelleligne_5);
var lyr_Nouvelleligne_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Nouvelleligne_5, 
                style: style_Nouvelleligne_5,
                popuplayertitle: 'Nouvelle ligne',
                interactive: false,
                title: '<img src="styles/legend/Nouvelleligne_5.png" /> Nouvelle ligne'
            });
var format_Arrtprsentsurlerseauactuel_6 = new ol.format.GeoJSON();
var features_Arrtprsentsurlerseauactuel_6 = format_Arrtprsentsurlerseauactuel_6.readFeatures(json_Arrtprsentsurlerseauactuel_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:2154'});
var jsonSource_Arrtprsentsurlerseauactuel_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Arrtprsentsurlerseauactuel_6.addFeatures(features_Arrtprsentsurlerseauactuel_6);
var lyr_Arrtprsentsurlerseauactuel_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Arrtprsentsurlerseauactuel_6, 
                style: style_Arrtprsentsurlerseauactuel_6,
                popuplayertitle: 'Arrêt présent sur le réseau actuel',
                interactive: true,
                title: '<img src="styles/legend/Arrtprsentsurlerseauactuel_6.png" /> Arrêt présent sur le réseau actuel'
            });
var format_Arrtpropospourlanouvelleligne_7 = new ol.format.GeoJSON();
var features_Arrtpropospourlanouvelleligne_7 = format_Arrtpropospourlanouvelleligne_7.readFeatures(json_Arrtpropospourlanouvelleligne_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:2154'});
var jsonSource_Arrtpropospourlanouvelleligne_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Arrtpropospourlanouvelleligne_7.addFeatures(features_Arrtpropospourlanouvelleligne_7);
var lyr_Arrtpropospourlanouvelleligne_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Arrtpropospourlanouvelleligne_7, 
                style: style_Arrtpropospourlanouvelleligne_7,
                popuplayertitle: 'Arrêt proposé pour la nouvelle ligne',
                interactive: false,
                title: '<img src="styles/legend/Arrtpropospourlanouvelleligne_7.png" /> Arrêt proposé pour la nouvelle ligne'
            });

lyr_ESRISatelliteArcGISWorld_Imagery_0.setVisible(true);lyr_Commune_1.setVisible(true);lyr_Isochronesde10minutesdepuislesnouveauxarrtsproposs_2.setVisible(true);lyr_Btimentsrsidentielsnoncouvertsparlerseauactuel_3.setVisible(true);lyr_LigneactuelleTHNS3_4.setVisible(true);lyr_Nouvelleligne_5.setVisible(true);lyr_Arrtprsentsurlerseauactuel_6.setVisible(true);lyr_Arrtpropospourlanouvelleligne_7.setVisible(true);
var layersList = [lyr_ESRISatelliteArcGISWorld_Imagery_0,lyr_Commune_1,lyr_Isochronesde10minutesdepuislesnouveauxarrtsproposs_2,lyr_Btimentsrsidentielsnoncouvertsparlerseauactuel_3,lyr_LigneactuelleTHNS3_4,lyr_Nouvelleligne_5,lyr_Arrtprsentsurlerseauactuel_6,lyr_Arrtpropospourlanouvelleligne_7];
...
lyr_Isochronesde10minutesdepuislesnouveauxarrtsproposs_2.set('fieldAliases', {'fid': 'fid', 'CostValue': 'CostValue', 'X': 'X', 'Y': 'Y', });
...
lyr_LigneactuelleTHNS3_4.set('fieldAliases', {'fid': 'fid', 'code': 'code', 'description': 'description', 'id': 'id', 'name': 'name', 'route_color': 'route_color', 'route_id': 'route_id', 'route_long_name': 'route_long_name', 'route_short_name': 'route_short_name', 'route_text_color': 'route_text_color', 'wheelchair_boarding': 'wheelchair_boarding', 'i': 'i', 'j': 'j', 'ij': 'ij', });
lyr_Nouvelleligne_5.set('fieldAliases', {'fid': 'fid', 'shape_id': 'shape_id', 'begin': 'begin', 'end': 'end', });
lyr_Arrtprsentsurlerseauactuel_6.set('fieldAliases', {'fid': 'fid', 'code': 'code', 'descriptio': 'descriptio', 'id': 'id', 'name': 'name', 'route_colo': 'route_colo', 'route_id': 'route_id', 'route_long': 'route_long', 'route_shor': 'route_shor', 'route_text': 'route_text', 'wheelchair': 'wheelchair', });
lyr_Arrtpropospourlanouvelleligne_7.set('fieldAliases', {'fid': 'fid', });
...
lyr_Isochronesde10minutesdepuislesnouveauxarrtsproposs_2.set('fieldImages', {'fid': 'TextEdit', 'CostValue': 'Range', 'X': 'TextEdit', 'Y': 'TextEdit', });
...
lyr_LigneactuelleTHNS3_4.set('fieldImages', {'fid': 'TextEdit', 'code': 'TextEdit', 'description': 'TextEdit', 'id': 'TextEdit', 'name': 'TextEdit', 'route_color': 'TextEdit', 'route_id': 'TextEdit', 'route_long_name': 'TextEdit', 'route_short_name': 'TextEdit', 'route_text_color': 'TextEdit', 'wheelchair_boarding': 'TextEdit', 'i': 'TextEdit', 'j': 'TextEdit', 'ij': 'TextEdit', });
lyr_Nouvelleligne_5.set('fieldImages', {'fid': 'TextEdit', 'shape_id': 'TextEdit', 'begin': 'Range', 'end': 'Range', });
lyr_Arrtprsentsurlerseauactuel_6.set('fieldImages', {'fid': 'TextEdit', 'code': 'TextEdit', 'descriptio': 'TextEdit', 'id': 'TextEdit', 'name': 'TextEdit', 'route_colo': 'TextEdit', 'route_id': 'TextEdit', 'route_long': 'TextEdit', 'route_shor': 'TextEdit', 'route_text': 'TextEdit', 'wheelchair': 'TextEdit', });
lyr_Arrtpropospourlanouvelleligne_7.set('fieldImages', {'fid': 'TextEdit', });
...
lyr_Isochronesde10minutesdepuislesnouveauxarrtsproposs_2.set('fieldLabels', {'fid': 'hidden field', 'CostValue': 'hidden field', 'X': 'hidden field', 'Y': 'hidden field', });
...
lyr_LigneactuelleTHNS3_4.set('fieldLabels', {'fid': 'hidden field', 'code': 'hidden field', 'description': 'hidden field', 'id': 'hidden field', 'name': 'hidden field', 'route_color': 'hidden field', 'route_id': 'hidden field', 'route_long_name': 'inline label - always visible', 'route_short_name': 'inline label - always visible', 'route_text_color': 'hidden field', 'wheelchair_boarding': 'hidden field', 'i': 'hidden field', 'j': 'hidden field', 'ij': 'hidden field', });
lyr_Nouvelleligne_5.set('fieldLabels', {'fid': 'hidden field', 'shape_id': 'hidden field', 'begin': 'hidden field', 'end': 'hidden field', });
lyr_Arrtprsentsurlerseauactuel_6.set('fieldLabels', {'fid': 'hidden field', 'code': 'hidden field', 'descriptio': 'hidden field', 'id': 'hidden field', 'name': 'inline label - always visible', 'route_colo': 'hidden field', 'route_id': 'hidden field', 'route_long': 'hidden field', 'route_shor': 'hidden field', 'route_text': 'hidden field', 'wheelchair': 'hidden field', });
lyr_Arrtpropospourlanouvelleligne_7.set('fieldLabels', {'fid': 'hidden field', });
lyr_Arrtpropospourlanouvelleligne_7.on('precompose', function(evt) {
