...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:2154',
            //extent: [977987.500000, 6702563.500000, 996354.812500, 6724977.500000],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([969013.885660, 6702298.823200, 1009426.226197, 6725158.328959], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Accessibilité et connectivité au réseau de bus</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (286 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Note de lecture : Cette cartographie illustre un indice d\'accessibilité synthétisant cinq variables par le biais d\'une Analyse en Composantes Principales (ACP). L\'étude porte exclusivement sur les communes de Pays de Montbéliard Agglomération (PMA) disposant d\'au moins un arrêt de bus.';
            }
